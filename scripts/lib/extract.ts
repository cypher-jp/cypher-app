...
- shikoku: 徳島 香川 愛媛 高知
- fukuoka: 福岡
- kyushu: 佐賀 長崎 熊本 大分 宮崎 鹿児島 (福岡・沖縄を除く九州)
- okinawa: 沖縄
...
- mexico: メキシコ
- brazil: ブラジル
- southamerica: ブラジル以外の南米(アルゼンチン、チリ、コロンビア、ペルー、ベネズエラ等)
- middleeast: 中東(サウジアラビア、UAE、カタール、イスラエル、トルコ等)
- morocco: モロッコ
- africa: モロッコ以外のアフリカ(エジプト、南アフリカ等)
...
- ヨーロッパの国が上の対応表(フランス/ドイツ/オランダ/ベルギー/イギリス/イタリア/スペイン/ポーランド/スイス/ロシア/ギリシャ/ポルトガル/スウェーデン/デンマーク/ノルウェー/フィンランド/オーストリア/チェコ/ハンガリー/ウクライナ)に含まれる場合は、必ずその国キー(または首都開催なら首都キー)を使うこと。対応表に無いヨーロッパの国(例: ルーマニア、ブルガリア等)は eu を使う。
- 読み取った都道府県名・市区町村名・国名・都市名は description の中に残すこと(ブロックへ丸めた場合でも情報が失われないようにするため)。
- type: 1on1/2on2等で対戦するものは battle、事前審査・作品披露・採点型のコンテスト大会(例: 「〜コンテスト」「CONTEST」表記、チーム作品のナンバー審査)は contest とする。不明な場合は "battle" とする。
