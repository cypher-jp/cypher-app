...
insert into events (title, type, genre, region, date, deadline, venue, description, flyer_url, ig_handle, ig_post_url, entry_url, status) values
  ('BATTLE OF TOKYO 2026', 'battle', 'all', 'tokyo', '2026-06-14', '2026-06-01',
  ...
  ('HOUSE NIGHT OSAKA', 'battle', 'house', 'osaka', '2026-05-23', '2026-05-15',
   '梅田CLUB QUATTRO',
  ...
  ('POPPING WORLD CUP — JAPAN QUALIFIER', 'battle', 'popping', 'tokyo', '2026-07-05', null,
   '新木場STUDIO COAST',
  ...
  ('LOCKING LEGENDS — TOKYO', 'showcase', 'locking', 'tokyo', '2026-08-10', null,
   '中野サンプラザ',
